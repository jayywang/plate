...
<div id="navigation">
        ...
        <div id="searchbar">
            ...
            <form action="plate_search_results.php" method="POST">
                <input class="search" id="recipe_recipe" type="text" placeholder="Search for a recipe, ingredient, etc." name="recipe_name">
...
<div class="explore-post">
            <div class="hover-shadow">
                <img class="food-photo" src="../img/chicken.png" alt="chicken">
                <div class="overlay"></div>
                <img class="save-icon" src="../img/heart.svg" alt = "heart icon">
                
            </div>

           

            <a href="../coming/coming.html"><p class="post-caption">Simple Steak Dinner</p></a>
